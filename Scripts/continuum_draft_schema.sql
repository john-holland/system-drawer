...
-- Run after continuum_episodes_schema.sql and continuum_thesaurus_schema.sql.
-- Requires min_thesaurus_version on episode_script (continuum_thesaurus_version_schema.sql).
