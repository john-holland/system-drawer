...
-- Run after core continuum schemas.
...
CREATE TABLE IF NOT EXISTS continuum_threaded_comments (
    id TEXT PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_threaded_comments_anchor ON continuum_threaded_comments(domain, anchor_id);
CREATE INDEX IF NOT EXISTS idx_threaded_comments_parent ON continuum_threaded_comments(parent_comment_id);
