...
def register_dialogue_routes(app, get_conn: GetConn, get_current_user: Callable[[], str]) -> None:
    try:
        from continuum_api.dialogue_parser import BOOK_CONCERT_FIXTURE, compile_dialogue_to_json
        from continuum_api.dialogue_db import (
            advance_session,
            choose_session,
            create_session,
        ...
        from continuum_api.dialogue_speech import inpaint_speech, synthesize_speech
    except ImportError:
