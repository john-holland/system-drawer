"""Ensure core thesaurus / lemma library schema on continuum.db."""
...
SCHEMA_FILES = (
    "continuum_thesaurus_schema.sql",
    "continuum_localization_schema.sql",
    "continuum_lemma_library_schema.sql",
