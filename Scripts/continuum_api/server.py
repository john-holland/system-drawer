...
try:
    from continuum_api import cave_adapter, cave_hierarchy_adapter, herb_garden
except ImportError:
    cave_adapter = None
...
def list_drafts():
    ...
    try:
        ...
        return jsonify({"error": str(e), "hint": "Apply continuum_draft_schema.sql"}), 500
    except Exception as e:
        return jsonify({"error": str(e)}), 500
...
def list_users():
    ...
    try:
        ...
        return jsonify({"error": str(e), "hint": "Apply continuum_audit_schema.sql"}), 500
    except Exception as e:
        return jsonify({"error": str(e)}), 500
...
def get_thesaurus_definition():
    ...
    try:
        ...
        return jsonify({"error": str(e), "hint": "Apply continuum_dictionary_schema.sql"}), 500
    except Exception as e:
        return jsonify({"error": str(e)}), 500
