/**
 * Continuum Cave shell: login, presence, RobotCopy / caveRoute delegation, session bridge.
 */
(function (global) {
  'use strict';
  ...
  function caveMessage(message, payload, opts) {
    return loadManifestMessages().then(function (messages) {
      ...
      return caveRoute('continuum:' + structural, payload, opts);
    });
  }
  ...
  global.ContinuumCaveClient = global.ContinuumCaveShell;
