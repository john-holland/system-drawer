"""
Cave adapter for continuum API: library search, upload, geocode, audit forwarding.
...
def _tenant_header() -> str:
    return os.environ.get("CONTINUUM_TENANT", "default")
...
def get_tome_header() -> str:
    ...
    try:
        ...
        return '<header class="tome-header"><nav><a href="/">Continuuum</a></nav></header>'
...
def get_tome_footer() -> str:
    ...
    try:
        ...
        return '<footer class="tome-footer"><small>Continuuum Episodic Content</small></footer>'
