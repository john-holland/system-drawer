...
from continuuuum_api.lemma_component_metadata import (
...
from continuuuum_api.lemma_merge import filter_entries
...
class LemmaComponentMetadataTests(unittest.TestCase):
    def setUp(self):
        ...
        schema = Path(__file__).resolve().parents[2] / "continuuuum_lemma_component_metadata_schema.sql"
    ...
    def test_filter_entries_by_component_type(self):
        ...
        self.conn.commit()
        from continuuuum_api.lemma_component_metadata import cache_row_to_api, component_creation_view
