...
from continuum_api.cave_loader import build_routes_overview
...
def tome_client(monkeypatch):
    ...
    with patch("continuum_api.table_read_chat.resaurce_route", side_effect=mock_resaurce), patch(
        "continuum_api.table_read_routes.resaurce_route", side_effect=mock_resaurce
    ), patch("continuum_api.table_read_routes.send_chat_message", return_value={"ok": True}):
