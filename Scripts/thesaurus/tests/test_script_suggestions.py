...
from continuum_api.localization_helpers import ensure_script_output_tables, is_draft_author
...
def test_create_and_list_suggestion(so_db):
    from continuum_api.script_output_routes import _suggestion_row
...
def test_ensure_draft_comment_thread(so_db):
    from continuum_api.localization_helpers import ensure_draft_comment_thread
