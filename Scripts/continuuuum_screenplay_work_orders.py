...
Requires script_speech_audio, script_sound_effects (continuuuum_screenplay_schema.sql)
and work_orders extended with work_order_source, speech_audio_id, sound_effect_id,
episode_script_id, farey_* (continuuuum_work_orders_screenplay_schema.sql).
"""
