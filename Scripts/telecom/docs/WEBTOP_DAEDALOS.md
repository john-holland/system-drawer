...
Mount each process iframe or React component that imports `window.continuuuumTelecomPump`.
...
Heavier desktop UX, Windows 98 aesthetic, built-in file manager — vs lighter Continuuuum OS.js-style shell.
