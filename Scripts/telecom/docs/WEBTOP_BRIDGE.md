...
Extends [continuum-script-editor BRIDGE.md](../../continuum_api/static/shared/continuum-script-editor/BRIDGE.md).
...
```javascript
window.continuumTelecomPump.apiRequest('GET', '/networks');
window.continuumTelecomPump.ring({ direction: 'incoming', phone: '1-1-555-0100' });
```
