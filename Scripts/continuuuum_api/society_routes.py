...
try:
    from continuuuum_api.building_prompt_interpreter import merge_building_stats, request_building_prompt, sync_building
    from continuuuum_api.building_type_resolver import resolve_building_type, resolve_for_zone
    from continuuuum_api.city_constraints_solver import solve as solve_constraints
    from continuuuum_api.city_network_assign import provision_building_device, provision_city_network
    from continuuuum_api.city_spatial_map import build_spatial_map
    from continuuuum_api.political_solver import tick_city
    from continuuuum_api.society_db import default_zone_document, ensure_society_tables, new_id
    from continuuuum_api.society_graph import apply_preset, compute_population_support
    from continuuuum_api.zoning_rules_engine import parse_zone_document
except ImportError:
