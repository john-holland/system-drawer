...
Prefer Unity menu Continuuuum > Export Built-in Vocabulary JSON for canonical output."""
...
CS = ROOT / "Assets" / "Continuuuum" / "VocabularyBuiltInRegistry.cs"
OUT = Path(__file__).resolve().parent / "builtin_vocabulary.json"
PREFIX = "urn:unity:continuuuum:builtin:v1:"
