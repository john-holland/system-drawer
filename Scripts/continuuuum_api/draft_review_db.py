"""Ensure draft episode and review workflow schema on continuuuum.db."""
...
DRAFT_SCHEMA = REPO_ROOT / "continuuuum_draft_schema.sql"
REVIEW_SCHEMA = REPO_ROOT / "continuuuum_review_schema.sql"
LOCALIZATION_WORKFLOW_SCHEMA = REPO_ROOT / "continuuuum_localization_workflow_schema.sql"
SCRIPT_OUTPUT_SCHEMA = REPO_ROOT / "continuuuum_script_output_schema.sql"
