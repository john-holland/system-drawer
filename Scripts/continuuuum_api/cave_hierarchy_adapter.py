...
def export_hierarchy_flatfile(output_path: str | Path) -> dict[str, Any]:
    ...
    adapters = {
        "cave": {"url": base, "used_in": ["continuuuum_api"], "functions": ["search_library", "geocode", "upload_document", "forward_audit", "get_tome_header", "get_tome_footer", "get_config_overview"]},
        "tome": {"used_in": ["continuuuum_api"], "slots": ["header", "footer"], "api": f"{base}/api/tome/container"},
