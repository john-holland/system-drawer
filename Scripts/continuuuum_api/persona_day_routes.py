...
DEFAULT_CIVIL_LOD_SETTINGS: dict[str, Any] = {
    ...
    "includeOptionalCivilDuties": False,
    "musicQuantizeEnabled": True,
    "keycardLateCheckoutTelecomPolicy": "room_then_cell",
}

VENUE_CATALOG = [
    {"kind": "Kitchen", "buildingTypeId": "restaurant", "hoursCron": "* 11-22 * * *"},
    {"kind": "SoupKitchen", "buildingTypeId": "soup_kitchen", "hoursCron": "* 11-20 * * *"},
    ...
    {"kind": "Factory", "buildingTypeId": "factory", "hoursCron": "* 6-18 * * 1-5"},
    {"kind": "LiquorStore", "buildingTypeId": "liquor_store", "hoursCron": "* 10-22 * * *"},
    {"kind": "PoliceStation", "buildingTypeId": "police_station", "hoursCron": "* * * * *"},
    {"kind": "FireStation", "buildingTypeId": "fire_station", "hoursCron": "* * * * *"},
    {"kind": "Bathroom", "buildingTypeId": "bathroom", "hoursCron": "* * * * *"},
    {"kind": "CarRepair", "buildingTypeId": "car_repair", "hoursCron": "* 8-18 * * 1-6"},
    {"kind": "BusDepot", "buildingTypeId": "bus_depot", "hoursCron": "* 5-23 * * *"},
    {"kind": "TransitHub", "buildingTypeId": "transit_hub", "hoursCron": "* 5-23 * * *"},
    {"kind": "Airport", "buildingTypeId": "airport", "hoursCron": "* 5-23 * * *"},
    {"kind": "Gym", "buildingTypeId": "gym", "hoursCron": "* 5-22 * * *"},
    {"kind": "House", "buildingTypeId": "house", "hoursCron": "* * * * *"},
    {"kind": "GasStation", "buildingTypeId": "gas_station", "hoursCron": "* * * * *"},
    {"kind": "TownHall", "buildingTypeId": "town_hall", "hoursCron": "* 8-17 * * 1-5"},
    {"kind": "UnemploymentOffice", "buildingTypeId": "job_center", "hoursCron": "* 8-17 * * 1-5"},
    {"kind": "NightClub", "buildingTypeId": "nightclub", "hoursCron": "* 21-3 * * *"},
    {"kind": "Bar", "buildingTypeId": "tavern", "hoursCron": "* 16-2 * * *"},
    {"kind": "Inn", "buildingTypeId": "inn", "hoursCron": "* * * * *"},
    {"kind": "Hotel", "buildingTypeId": "hotel", "hoursCron": "* * * * *"},
    {"kind": "MilitaryCheckpoint", "buildingTypeId": "military_checkpoint", "hoursCron": "* * * * *"},
    {"kind": "SpyAgency", "buildingTypeId": "spy_agency", "hoursCron": "* 8-20 * * 1-5"},
    {"kind": "Embassy", "buildingTypeId": "embassy", "hoursCron": "* 8-18 * * 1-5"},
    {"kind": "GovLegislative", "buildingTypeId": "legislative", "hoursCron": "* 8-17 * * 1-5"},
    {"kind": "Monarchic", "buildingTypeId": "palace", "hoursCron": "* * * * *"},
    {"kind": "Spa", "buildingTypeId": "spa", "hoursCron": "* 9-20 * * *"},
    {"kind": "PrivateIndustry", "buildingTypeId": "office_building", "hoursCron": "* 9-17 * * 1-5"},
    {"kind": "BarberShop", "buildingTypeId": "barbershop", "hoursCron": "* 9-18 * * 1-6"},
