...
namespace Planetary
{
    ...
    {
        [Tooltip("Continuuuum base URL e.g. http://localhost:5050")]
        ...
        {
            string url = $"{continuuuumBaseUrl.TrimEnd('/')}/api/planet/tiles?planet_id={planetId}&face={(int)face}&lod={lod}&x={chunkX}&y={chunkY}";
