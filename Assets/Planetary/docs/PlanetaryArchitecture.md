...
Planet surfaces use **PlanetaryPlanarBase** (multi-source height), **SdfMax** solver primitives (noise, stamps, lat/lon shell), **volleyball-stitched** cube-sphere meshes, **Continuuuum** tile streaming, and **progressive SDF horizon LOD**.
