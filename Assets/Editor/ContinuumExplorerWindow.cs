...
public class ContinuumExplorerWindow : EditorWindow
{
    ...
    private string[] tableNames = { "spatial_4d", "document_blobs", "semantic_chunks", "unique_kernels", "compression_runs", "research_suggestions", "continuum_meta", "library_documents", "episodes", "episode_assets", "episode_script", "draft_episodes", "draft_episode_script", "narrative_type_detections", "causality_structure", "work_orders", "vocabulary_render_masks", "vocabulary_render_mask_buckets", "languages", "thesaurus_entries", "thesaurus_alternatives", "thesaurus_ast_nodes", "thesaurus_translations", "change_of_basis_rules", "change_of_basis_word_overrides", "script_speech_audio", "script_sound_effects", "script_audio_by_language", "dictionary_definitions", "api_audit_log", "user_presence" };
