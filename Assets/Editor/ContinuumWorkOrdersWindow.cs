...
/// <summary>
/// Work orders browser for continuum DB. View, assign, and export fungible work orders from causality tree.
/// Requires work_orders table (Scripts/continuum_episodes_schema.sql).
/// </summary>
public class ContinuumWorkOrdersWindow : EditorWindow
{
    ...
    {
        var w = GetWindow<ContinuumWorkOrdersWindow>("Continuum Work Orders");
