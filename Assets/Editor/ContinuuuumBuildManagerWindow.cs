...
/// </summary>
public class ContinuuuumBuildManagerWindow : EditorWindow
{
    [SerializeField] private UscBuildMode mode = UscBuildMode.PackedPublish;
    [SerializeField] private string tenantId = "default";
    [SerializeField] private string continuuuumBaseUrl = "http://localhost:5050";
    ...
    [MenuItem("Window/Continuuuum/Build Manager")]
    public static void ShowWindow()
    {
        var window = GetWindow<ContinuuuumBuildManagerWindow>("Continuuuum Build Manager");
    ...
    private void OnGUI()
    {
        ...
        EditorGUILayout.LabelField("Continuuuum Build Manager", EditorStyles.boldLabel);
        ...
        continuuuumBaseUrl = EditorGUILayout.TextField("Continuuuum URL", continuuuumBaseUrl);
    ...
    private void GenerateDraftManifest()
    {
        ...
        manifest.notes = "Generated by ContinuuuumBuildManagerWindow (v1 manifest+stub flow).";
    ...
    private void RunPackedPublishStub()
    {
        ...
        Debug.Log("[ContinuuuumBuildManager] Stub packed-publish command:\n" + cmd);
