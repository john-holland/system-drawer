...
/// <summary>IMGUI power diamond with optional blue / red / dashed-white overlays.</summary>
public static class PowerDiamondDrawer
{
    ...
    public static void DrawOverlay(Rect rect, string[] axes, float[] blue01, float[] redLimit01, float[] dashedWhite01, float threatHalo01)
    {
        ...
        DrawPoly(c, top, right, bottom, left, dashedWhite01, Color.clear, Color.white, 2f, true);
        Handles.EndGUI();
