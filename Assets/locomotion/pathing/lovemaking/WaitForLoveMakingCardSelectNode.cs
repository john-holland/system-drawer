...
/// <summary>Unscaled wait for LoveCard slow-time confirm/cancel.</summary>
public sealed class WaitForLoveMakingCardSelectNode : BehaviorTreeNode
{
    public LoveMakingCardSelectionSession session;
    ...
    public override void OnEnter(BehaviorTree tree)
    {
        ...
        if (session == null && tree != null)
            session = tree.GetComponent<LoveMakingCardSelectionSession>();
