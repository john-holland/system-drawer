...
{
    /// <summary>
    /// Loads dialogue audio clips from local paths or Continuum USC audioRef URLs with caching.
    /// </summary>
    public static class DialogueAudioLoader
    {
        ...
        public static AudioClip LoadSync(string audioRef, string continuumBaseUrl = "http://127.0.0.1:5050")
        {
            ...
            string url = ResolveUrl(audioRef, continuumBaseUrl);
        ...
        public static string ResolveUrl(string audioRef, string continuumBaseUrl)
        {
            ...
            if (audioRef.StartsWith("usc://", StringComparison.OrdinalIgnoreCase))
            {
                ...
                return continuumBaseUrl.TrimEnd('/') + "/api/library/documents/" + path;
            }

            return continuumBaseUrl.TrimEnd('/') + "/" + audioRef.TrimStart('/');
        }
    }
}
