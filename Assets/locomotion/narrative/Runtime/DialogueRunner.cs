...
namespace Locomotion.Narrative
{
    ...
    public sealed class DialogueRunner : MonoBehaviour
    {
        ...
        public string continuumBaseUrl;
        ...
        void Awake()
        {
            ...
            if (string.IsNullOrEmpty(continuumBaseUrl))
                continuumBaseUrl = ContinuumApiConfig.GetApiBaseUrl();
        }
        ...
        public void PlayCurrentLine()
        {
            ...
            if (!string.IsNullOrEmpty(_currentNode.audioRef))
                clip = DialogueAudioLoader.LoadSync(_currentNode.audioRef, continuumBaseUrl);
        ...
        {
            string url = continuumBaseUrl.TrimEnd('/') + path;
