...
{
    /// <summary>
    /// Thin client for Continuuuum dialogue speech synthesize/inpaint APIs (replaces local StubSoundToMLAdapter for TTS).
    /// </summary>
    public static class ContinuuuumDialogueSpeechClient
    {
        [Serializable]
        class SynthRequest
        {
            ...
            string baseUrl = null)
        {
            ...
            baseUrl = (baseUrl ?? ContinuuuumApiConfig.GetApiBaseUrl()).TrimEnd('/');
