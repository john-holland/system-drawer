...
{
    public static class TreeGrowthOpenCloseBt
    {
        public static OpenCloseTopologyAsset FromSteps(TreeGrowthTravelAgent agent)
        {
            var asset = ScriptableObject.CreateInstance<OpenCloseTopologyAsset>();
            asset.linearOnly = true;
            asset.rootId = "tree_plot";
            var root = asset.Root;
            root.nodeId = "tree_plot";
