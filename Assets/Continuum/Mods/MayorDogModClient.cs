...
namespace Continuum.Mods
{
    /// <summary>Fetches mod bootstrap manifest from Continuum and caches for offline play.</summary>
    public class MayorDogModClient : MonoBehaviour
    {
        ...
        void Awake()
        {
            if (string.IsNullOrEmpty(apiBaseUrl))
                apiBaseUrl = ContinuumApiConfig.GetApiBaseUrl();
        }
