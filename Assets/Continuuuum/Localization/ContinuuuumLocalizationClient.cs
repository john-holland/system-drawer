...
/// <summary>Live Continuuuum API client for localization endpoints.</summary>
public sealed class ContinuuuumLocalizationClient : IContinuuuumLocalizationClient, IContinuuuumNotificationClient
{
    readonly string _baseUrl;

    public ContinuuuumLocalizationClient(string baseUrl = null)
    {
        _baseUrl = (baseUrl ?? ContinuuuumApiConfig.GetApiBaseUrl()).TrimEnd('/');
    }
