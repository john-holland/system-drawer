...
/// <summary>Editor Continuuuum client — uses ContinuuuumEditorApiClient and ContinuuuumSettings headers.</summary>
public sealed class ContinuuuumEditorLocalizationClient : IContinuuuumLocalizationClient, IContinuuuumNotificationClient
{
    public static readonly ContinuuuumEditorLocalizationClient Instance = new ContinuuuumEditorLocalizationClient();

    public async Task<LocalizationPropertySpecRecord[]> GetPropertySpecsAsync(CancellationToken ct = default)
    {
        var r = await ContinuuuumEditorApiClient.RequestAsync("GET", "/api/thesaurus/property-specs", null, ct);
    ...
    {
        var r = await ContinuuuumEditorApiClient.RequestAsync("GET",
    ...
    public async Task<ScriptApplyEditResult> ApplyScriptEditAsync(string draftEpisodeId, string oldText, string newText, CancellationToken ct = default)
    {
        ...
        var r = await ContinuuuumEditorApiClient.RequestAsync("POST", $"/api/scripts/{Uri.EscapeDataString(draftEpisodeId ?? "")}/apply-edit", body, ct);
    ...
    {
        var r = await ContinuuuumEditorApiClient.RequestAsync("GET", $"/api/localization/change-lists/{Uri.EscapeDataString(changeListId ?? "")}", null, ct);
    ...
    {
        await ContinuuuumEditorApiClient.RequestAsync("PATCH", $"/api/localization/change-list-items/{Uri.EscapeDataString(itemId ?? "")}",
    ...
    public async Task SaveChangeListAsync(string changeListId, LocalizationChangeListItemRecord[] items = null, CancellationToken ct = default)
    {
        ...
        await ContinuuuumEditorApiClient.RequestAsync("POST", $"/api/localization/change-lists/{Uri.EscapeDataString(changeListId ?? "")}/save", body, ct);
    }
        ...
        CancellationToken ct = default)
    {
        ...
        var r = await ContinuuuumEditorApiClient.RequestAsync("POST", "/api/thesaurus/clause-bindings", body, ct);
        if (!r.success || string.IsNullOrEmpty(r.json))
            return null;
    ...
    {
        await ContinuuuumEditorApiClient.RequestAsync("POST", $"/api/localization/change-lists/{Uri.EscapeDataString(changeListId ?? "")}/submit-for-review", "{}", ct);
    }
    ...
    {
        var r = await ContinuuuumEditorApiClient.RequestAsync("GET", $"/api/reviews/{Uri.EscapeDataString(reviewId ?? "")}/comments/archive", null, ct);
    ...
    {
        await ContinuuuumEditorApiClient.RequestAsync("PATCH", $"/api/reviews/{Uri.EscapeDataString(reviewId ?? "")}/comments/{Uri.EscapeDataString(commentId ?? "")}",
    ...
    {
        var r = await ContinuuuumEditorApiClient.RequestAsync("GET", "/api/drafts/episodes", null, ct);
    ...
    {
        var r = await ContinuuuumEditorApiClient.RequestAsync("GET", $"/api/drafts/episodes/{Uri.EscapeDataString(draftEpisodeId ?? "")}/script", null, ct);
    ...
    public async Task PutDraftScriptAsync(string draftEpisodeId, string scriptText, string language = "en", CancellationToken ct = default)
    {
        ...
        await ContinuuuumEditorApiClient.RequestAsync("PUT", $"/api/drafts/episodes/{Uri.EscapeDataString(draftEpisodeId ?? "")}/script", body, ct);
    }
    ...
    {
        var r = await ContinuuuumEditorApiClient.RequestAsync("GET", $"/api/notifications?limit={limit}", null, ct);
        if (!r.success)
    ...
    {
        await ContinuuuumEditorApiClient.RequestAsync("POST", $"/api/notifications/{Uri.EscapeDataString(notificationId ?? "")}/read", "{}", ct);
    }
    ...
    public async Task<ThesaurusEntryPropertyRecord[]> GetEntryPropertiesAsync(string entryId = null, CancellationToken ct = default)
    {
        ...
        var r = await ContinuuuumEditorApiClient.RequestAsync("GET", path, null, ct);
    ...
    public async Task PutEntryPropertyAsync(string entryId, string propertyKey, string propertyValue, CancellationToken ct = default)
    {
        ...
        await ContinuuuumEditorApiClient.RequestAsync("PUT", "/api/thesaurus/entry-properties", body, ct);
    }
    ...
    public Task DeleteEntryPropertyAsync(string entryId, string propertyKey, CancellationToken ct = default)
    {
        ...
        return ContinuuuumEditorApiClient.RequestAsync("DELETE", path, null, ct);
    }

    public Task<ApiCallResult> CallRawAsync(string method, string path, string body, CancellationToken ct = default) =>
        ContinuuuumEditorApiClient.RequestAsync(method, path, body, ct);
