...
/// <summary>Exports <see cref="VocabularyBuiltInRegistry"/> to continuuuum_api JSON for the lemma library API.</summary>
public static class VocabularyBuiltInJsonExporter
{
    const string RelativeOutput = "Scripts/continuuuum_api/data/builtin_vocabulary.json";

    [MenuItem("Continuuuum/Export Built-in Vocabulary JSON")]
