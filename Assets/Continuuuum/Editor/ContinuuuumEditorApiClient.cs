...
/// <summary>Editor API client — all Continuuuum HTTP from Unity Editor uses this (WebView never calls network directly).</summary>
public static class ContinuuuumEditorApiClient
{
        ...
        CancellationToken ct = default)
    {
        ...
        string url = ContinuuuumEditorSession.ApiBaseUrl + path;
        ...
        req.SetRequestHeader("X-User-ID", ContinuuuumEditorSession.UserId);
        req.SetRequestHeader("X-Tenant-ID", ContinuuuumEditorSession.TenantId);
