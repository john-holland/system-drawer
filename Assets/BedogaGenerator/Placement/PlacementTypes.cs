...
/// <summary>Shared placement fit/stack enums used by BedogaGenerator and locomotion terminal slots.</summary>
public enum PlacementFitX { Center, Left, Right }
public enum PlacementFitY { Center, Down, Up }
public enum PlacementFitZ { Center, Backward, Forward }
public enum PlacementAxisDirection { PosX, NegX, PosY, NegY, PosZ, NegZ }


/// <summary>9-way cell origin for radial build (PixelLight side dropdown).</summary>
public enum RadialSide
{
    Center = 0,
    UpperLeft = 1,
    Up = 2,
...
/// <summary>How neighboring radial pieces meet. Glue/Hardware are sockets only.</summary>
public enum RadialJoinKind
{
    Natural = 0,
    Offset = 1,
    Glue = 2,
...
/// <summary>Authored edge-loop face as a radial origin.</summary>
[System.Serializable]
public struct CustomRadialSidePose
{
    ...
    public UnityEngine.Bounds jointMiddle;
    public UnityEngine.Bounds flyAway;
    public float customAngle;
    public bool hasCustomAngleObject;
    public UnityEngine.Vector3 customAngleObjectWorld;
}
...
public sealed class RadialBuildSpec
{
    ...
    public UnityEngine.Vector3 centerPostPosition;
    ...
    {
        if (cfg == null) return;
        count = UnityEngine.Mathf.Max(1, cfg.count);
        radius = cfg.radius;
    ...
    public float EffectiveJoinOffset() =>
        joinKind == RadialJoinKind.Natural ? 0f : UnityEngine.Mathf.Max(0f, joinOffset);
}
