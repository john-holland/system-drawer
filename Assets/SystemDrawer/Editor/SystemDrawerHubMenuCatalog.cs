...
internal static class SystemDrawerHubMenuCatalog
{
    ...
    {
        new Entry("Create", "Create Object", "Window/System Drawer/Create Object"),
        ...
        new Entry("Animation", "Vehicle Video Steering", "Window/System Drawer/Animation/Vehicle Video Steering"),
        ...
        new Entry("Animation", "Mesh animation bone assignment", "Window/System Drawer/Animation/Mesh animation bone assignment"),
        ...
        new Entry("City Planning", "Vehicle Video Steering", "Locomotion/Vehicle Video Steering"),
        new Entry("City Planning", "City Pixel Grid Designer", "Locomotion/City Pixel Grid Designer"),
        new Entry("City Planning", "Road Lanes Designer", "Locomotion/Road Lanes Designer"),
        ...
        new Entry("City Planning", "Courtroom PixelLight Designer", "Locomotion/Courtroom PixelLight Designer"),
        ...
        new Entry("Narrative", "Relationship Travel Agent", "Locomotion/Relationship Travel Agent"),
        new Entry("Narrative", "Conversation Bus", "Locomotion/Conversation Bus"),
        new Entry("Narrative", "Law Travel Agent", "Locomotion/Law Travel Agent"),
        new Entry("Narrative", "Vote Runs", "Locomotion/Vote Runs"),
        ...
        new Entry("Civil", "Relationship Travel Agent", "Locomotion/Relationship Travel Agent"),
        new Entry("Civil", "Courtroom PixelLight Designer", "Locomotion/Courtroom PixelLight Designer"),
        new Entry("Civil", "Conversation Bus", "Locomotion/Conversation Bus"),
        new Entry("Civil", "Law Travel Agent", "Locomotion/Law Travel Agent"),
        new Entry("Civil", "Voting Place", "Locomotion/Voting Place"),
        new Entry("Civil", "Ballot UI", "Locomotion/Ballot UI"),
        new Entry("Civil", "Vote Runs", "Locomotion/Vote Runs"),
        ...
        new Entry("Mesh", "Skinned Loop Section", "Window/System Drawer/Mesh/Skinned Loop Section"),
        new Entry("Mesh", "Image to Model", "Window/System Drawer/Mesh/Image to Model"),
        ...
        new Entry("Diagnostics", "Skinned Loop Section", "Window/System Drawer/Mesh/Skinned Loop Section"),
        ...
        new Entry("Networking", "Game Sessions", "Window/System Drawer/Networking/Game Sessions"),
        new Entry("Networking", "Game Lobbies", "Window/System Drawer/Networking/Game Lobbies"),
        new Entry("Networking", "Lobby Prefab Sync", "Window/System Drawer/Networking/Lobby Prefab Sync"),
