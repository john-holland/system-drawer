...
/** Continuuuum hub SPAs served by continuuuum_api (Flask on 5050 in production). */
const HUB_HTML = {
  '/ui': 'ui.html',
...
/** Serve Drawer 2 continuuuum_api/static during Vite dev (no Flask required for static/hub HTML). */
export function continuuuumStaticPlugin() {
  const staticRoot = path.resolve(
    path.dirname(fileURLToPath(import.meta.url)),
    '../Scripts/continuuuum_api/static',
  );

  return {
    name: 'continuuuum-static',
